          ...
          <div className="w-full flex flex-col max-w-[500px]  text-[#060606] ">
            ...
            <form onSubmit={handleSubmit} >
              ...
              <div className="w-full flex flex-col my-4">
                <button type="submit" className="w-full text-white my-2 font-semibold bg-black rounded-md p-4 text-center flex items-center justify-center cursor-pointer" disabled={isSigningUp}>
                  {isSigningUp ? (
                    <>
